...
if(__name__ == "__main__"):
    ...
    sn.timeTrace.setHistorySize(30)
    
    # you can set a custom file name or path
    sn.setPTUFilePath("C:\\Users\\lbquy\\Downloads\\snAPI-main\\snAPI-main\\demos\\DemoTiTrPTUUU.ptu")
    
    # measure 10s
    sn.timeTrace.measure(30000, waitFinished=False, savePTU=True)
    ...
    while True: 
        ...
        plt.clf()
        plt.plot(times, counts[1], linewidth=2.0, label='sync')
